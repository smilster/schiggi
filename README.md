...
This is a basic example of how to use a GitHub workflow runner to create data and push to the very same repository. It employs <code>actions/checkout@v4</code> and <code>EndBug/add-and-commit@v9</code>.
